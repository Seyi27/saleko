...
const EscrowServicePage = () => {
  return (
    <PageWrapper classname="escrow_container">
      ...
      <div className="escrow_body_wrapper">
        <p className="escrow_text">
          ...
          Escrow service. Our Escrow service ensures that both parties are held
          accountable throughout the transaction process.
        </p>
        ...
        <div className="escrow_content_wrapper">
          <div className="escrow_left_container">
            <p className="escrow_text">
              When a shopper places an order and makes a payment, the funds are
              held in escrow until the order is delivered. Only after the
              customer has received their order without any issues or complaints
              is the payment released to the merchant's account.
            </p>

            <p className="escrow_text">
              At Saleko, we understand the importance of trust and transparency
              when it comes to online transactions. That's why our Escrow
              service provides both buyers and sellers with the peace of mind
              they need to conduct transactions with confidence.
            </p>

            <p className="escrow_text">
              Choose Saleko for a seamless and secure buying and selling
              experience, where both parties can trust that their interests are
              protected.
            </p>
          </div>
