...
const NegotiationPage = () => {
  ...
  return (
    <>
      <PageWrapper classname="negotiation_main_container">
        <div
        ...
        <div>
          <p style={{ fontWeight: "bold", color: "#4B4B4B" }}>Negotiation</p>
          ...
          <div className="negotiation_body_container">
            ...
            >
              <div>
                <p className="negotiation_header_text">Negotiation Begins</p>
                  ...
                  <div className="negotiation_chatbody_bottom_container">
                    <div className="bid_price_container">
                      ...
                      <input
                        ...
                        style={{
                          backgroundColor: !addToCartdisabled ? "#DADADA" : "",
                        }}
            ...
            >
              ...
              <div style={{ marginTop: "25px" }}>
                <img
                  src={productDetailsData?.image_urls?.[0].local_url ?? saleko_green}
                ...
                <p className="negotiated_item_property">Vendor: SmithField</p>
                <p className="negotiated_item_property">
                  Negotiation Status:{" "}
                  <span style={{ color: "#084c3f" }}>Ongoing Negotiation</span>
                </p>
                <p className="negotiated_item_property">
                  Negotiated Price:{" "}
              ...
              {!addToCartdisabled && (
                <p className="negotiated_expiry_text">
                  This negotiated price would last till: 2023-05-05 05:04pm.
                  Kindly purchase the product before the expiry time, otherwise
                  the price would be reversed to the actual price.
                </p>
              )}
            </div>
          </div>
