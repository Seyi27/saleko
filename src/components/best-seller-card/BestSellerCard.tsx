        ...
        <div className="best_seller_product_details">
          <div>
            ...
            <div className="best_seller_price_container">
              <span className={`best_seller_price ${item.former_price && "best_seller_price_red"}`}>₦{item.price}</span>
              <span className="best_seller_former_price">₦{item.former_price}</span>
            </div>
          </div>
